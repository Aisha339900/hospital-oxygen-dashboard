...
export default function DashboardReportActions({
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      showNotice("PDF downloaded.", false);
    } catch (e) {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      showNotice(response?.message || "Report emailed to your account.", false);
    } catch (e) {
            ...
            <div className="report-actions__email-block">
              ...
              {canUseEmail && String(userEmail || "").trim() ? (
                <p className="report-actions__email-to">
                  <FiMail aria-hidden />
                  <span>
                    Email uses your account: <strong>{String(userEmail).trim()}</strong>
                  </span>
                </p>
              ) : null}
              {/* {emailBlockedReason ? (
